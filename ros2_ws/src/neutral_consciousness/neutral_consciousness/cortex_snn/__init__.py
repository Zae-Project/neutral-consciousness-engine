...
- reentrant_processor: Bidirectional binding loop (thalamocortical convergence)
...
Architecture (Feinberg & Mallatt Two-Step Model):
  ...
  Reentrant Processor: 4,000 LIF neurons, bidirectional binding with convergence

  Total: ~20,700 LIF neurons
...
from .reentrant_processor import ReentrantProcessor

__all__ = [
    'VisualCortexNode', 'DreamEngine', 'SensoryTectum',
    'LimbicNode', 'ReentrantProcessor',
]
